...
class CMultipleTypeValuesUMapContainer // todo - use either Pool or Container for this class and vectorpool class
{
public:
...
template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntry(KeyClass key, bool bValue)
{
	setEntry<bool>(key, bValue);
}

template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntry(KeyClass key, uint32 uiValue)
{
	setEntry<uint32>(key, uiValue);
}

template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntry(KeyClass key, int32 iValue)
{
	setEntry<int32>(key, iValue);
}

template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntry(KeyClass key, float32 fValue)
{
	setEntry<float32>(key, fValue);
}

template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntry(KeyClass key, std::string strValue)
{
...
template <class KeyClass>
template <typename ValueType>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntry(KeyClass key, ValueType value)
{
...
template <class KeyClass>
template <typename ValueType>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntryPointer(KeyClass key, ValueType *pValue)
{
	m_umapEntries[key] = pValue;
}

template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::setEntryVoidPointer(KeyClass key, void *pValue)
{
	m_umapEntries[key] = pValue;
}

template <class KeyClass>
bool				CMultipleTypeValuesUMapContainer<KeyClass>::doesEntryExist(KeyClass key)
{
	return m_umapEntries.count(key) == 1;
}

template <class KeyClass>
bool				CMultipleTypeValuesUMapContainer<KeyClass>::isEmpty(void)
{
	return m_umapEntries.empty();
}

template <class KeyClass>
uint32				CMultipleTypeValuesUMapContainer<KeyClass>::getEntryCount(void)
{
...
template <class KeyClass>
template <typename ValueType>
ValueType			CMultipleTypeValuesUMapContainer<KeyClass>::getEntry(KeyClass key)
{
...
template <class KeyClass>
template <typename ValueType>
ValueType*			CMultipleTypeValuesUMapContainer<KeyClass>::getEntryPointer(KeyClass key)
{
...
template <class KeyClass>
void*				CMultipleTypeValuesUMapContainer<KeyClass>::getEntryVoidPointer(KeyClass key)
{
	if (!doesEntryExist(key))
	{
		return nullptr;
...
template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::removeAllEntries(void)
{
...
template <class KeyClass>
void				CMultipleTypeValuesUMapContainer<KeyClass>::removeEntry(KeyClass key)
{
