...
template <class Key, class Value>
bool				CUMapContainer<Key, Value>::doesKeyExist(Key key)
{
	return m_umapEntries.count(key) != 0;
}

template <class Key, class Value>
uint32				CUMapContainer<Key, Value>::getEntryCount(void)
{
	return m_umapEntries.size();
}

template <class Key, class Value>
void				CUMapContainer<Key, Value>::setEntry(Key key, Value value)
{
	m_umapEntries[key] = value;
}

template <class Key, class Value>
Value				CUMapContainer<Key, Value>::getEntry(Key key)
{
	if (doesKeyExist(key))
	{
...
template <class Key, class Value>
Key				CUMapContainer<Key, Value>::getKeyByValue(Value value)
{
...
template <class Key, class Value>
void				CUMapContainer<Key, Value>::removeEntry(Key key)
{
...
template <class Key, class Value>
void				CUMapContainer<Key, Value>::removeAllEntries(void)
{
	m_umapEntries.clear();
}

template <class Key, class Value>
void				CUMapContainer<Key, Value>::swapEntries(Key key1, Key key2)
{
