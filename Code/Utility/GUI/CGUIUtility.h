...
{
public:
	static void								setParentWindowHwnd(HWND hParentWindowHwnd) { CGUIUtility::m_hParentWindowHwnd = hParentWindowHwnd; }
	static HWND								getParentWindowHwnd(void) { return CGUIUtility::m_hParentWindowHwnd; }
