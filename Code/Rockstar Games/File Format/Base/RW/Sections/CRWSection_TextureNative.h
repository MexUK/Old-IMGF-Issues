...
#include "RW/Entries/CRWEntry_TextureNative_MipMap.h"
#include "CSize2D.h"
#include "Platform/ePlatform.h"
#include <string>
#include <vector>

class CRWSection_TextureNative : public CRWSection
{
public:
	...
	eRasterDataFormat			detectRasterDataFormat(void);

	uint32						getBodyLength(void);
	void						unswizzlePS2Format(void);
	
	CVectorPool<CRWEntry_TextureNative_MipMap*>&	getMipMaps(void) { return m_vecMipMaps; }
	...
	void						setRasterDataFormat(eRasterDataFormat eRasterDataFormatValue, bool bUpdateTXDRasterDataFormat = true);
	...
	void						setDXTCompressionType(eDXTCompressionType eCompressionAlgorithm) { m_eDXTCompressionType = eCompressionAlgorithm; }
	eDXTCompressionType			getDXTCompressionType(void) { return m_eDXTCompressionType; }
...
private:
	...
	eDXTCompressionType			m_eDXTCompressionType;
	...
	CVectorPool<CRWEntry_TextureNative_MipMap*>	m_vecMipMaps;
};
