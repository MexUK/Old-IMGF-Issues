...
class CRWEntry_2dEffect_EnterExit : public C2dEffect
{
public:
	...
	void							setMarkerApporximationRadius(CVector2D& vecMarkerApporximationRadius) { m_vecMarkerApporximationRadius = vecMarkerApporximationRadius; }
	CVector2D&						getMarkerApporximationRadius(void) { return m_vecMarkerApporximationRadius; }

	void							setExitMarkerPosition(CVector3D& vecExitMarkerPosition) { m_vecExitMarkerPosition = vecExitMarkerPosition; }
	CVector3D&						getExitMarkerPosition(void) { return m_vecExitMarkerPosition; }
...
private:
	...
	CVector2D						m_vecMarkerApporximationRadius; // The radius of the approximation to the marker X and Y
	CVector3D						m_vecExitMarkerPosition; // The position of exit - marker(offset relative to the object) (Always 0 ? )
