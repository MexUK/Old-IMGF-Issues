...
class CRWEntry_2dEffect_PedAttractor : public C2dEffect
{
public:
	...
	void							setRotation(uint8 ucRotationIndex, CVector3D& vecRotation) { m_vecRotation[ucRotationIndex] = vecRotation; }
	CVector3D&						getRotation(uint8 ucRotationIndex) { return m_vecRotation[ucRotationIndex]; }
