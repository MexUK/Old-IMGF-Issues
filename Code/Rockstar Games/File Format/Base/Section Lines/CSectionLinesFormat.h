...
class CSectionLinesFormat : public CFormat
{
public:
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::CSectionLinesFormat(void) :
	CFormat(false),
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
void				CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::unload(void)
{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
void				CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::unserializeLine(void)
{
	// initialize
	...
	if (strActiveLine == "" || CStringUtility::toUpperCase(strActiveLine) == "END")
	{
	...
	else
	{
		...
		else
		{
			...
			pDataReader->setLineTokens(CStringUtility::split(CStringUtility::replace(strActiveLine, ",", ""), " "));
			try
			{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
void				CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::unserializeText(void)
{
	CDataReader *pDataReader = CDataReader::getInstance();
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
void				CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::serializeText(void)
{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
std::vector<std::vector<EntryClass*>>	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getSectionsBySection(SectionEnum eFormatSectionValue)
{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
OtherEntryClass*	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::createOtherEntry(void)
{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
SectionEntryClass*	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::createSectionEntry(SectionEnum eFormatSectionValue)
{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
std::vector<std::string>	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getModelNames(void)
{
	...
	for (auto it : getSectionEntries())
	{
		for (EntryClass *pFormatEntry : it.second)
		{
			...
			{
				std::string strModelName = CStringUtility::toUpperCase(((DataEntryClass*)pFormatEntry)->getModelName());
				if (strModelName != "")
				{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
std::vector<std::string>	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getTXDNames(void)
{
	...
	for (auto it : getSectionEntries())
	{
		for (EntryClass *pFormatEntry : it.second)
		{
			if (pFormatEntry->getEntryType() == SECTION_LINES_ENTRY_DATA)
			{
				std::string strTXDName = CStringUtility::toUpperCase(((DataEntryClass*)pFormatEntry)->getTXDName());
				if (strTXDName != "")
				{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
std::vector<std::string>	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getTXDNamesFromModelNames(std::vector<std::string>& vecModelNames)
{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
std::string			CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getTXDNameFromModelName(std::string strModelName)
{
	...
	for (auto it : getSectionEntries())
	{
		for (EntryClass *pFormatEntry : it.second)
		{
			if (pFormatEntry->getEntryType() == SECTION_LINES_ENTRY_DATA && strModelName == CStringUtility::toUpperCase(((DataEntryClass*)pFormatEntry)->getModelName()))
			{
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
std::vector<EntryClass*>	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getEntriesByModelName(std::string strModelName)
{
	strModelName = CStringUtility::toUpperCase(strModelName);
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
std::vector<EntryClass*>	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getEntriesByTXDName(std::string strTXDName)
{
	strTXDName = CStringUtility::toUpperCase(strTXDName);
	std::vector<EntryClass*> vecFormatEntries;
	for (auto it : getSectionEntries())
	{
		for (EntryClass *pFormatEntry : it.second)
		{
			if (pFormatEntry->getEntryType() == SECTION_LINES_ENTRY_DATA && strTXDName == CStringUtility::toUpperCase(((DataEntryClass*)pFormatEntry)->getTXDName()))
			{
				vecFormatEntries.push_back(pFormatEntry);
			}
		}
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
template<class EntryClass2>
std::vector<EntryClass2*>	CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::getEntriesBySection(SectionEnum eSectionValue)
{
...
bool						sortSectionLinesEntries_ObjectID(EntryClass *pFormatEntry1, EntryClass *pFormatEntry2)
{
	// data lines
...
template<class FormatClass, class EntryClass, typename SectionEnum, class OtherEntryClass, class SectionEntryClass, class DataEntryClass>
void				CSectionLinesFormat<FormatClass, EntryClass, SectionEnum, OtherEntryClass, SectionEntryClass, DataEntryClass>::sortAllSectionsByObjectId(void)
{
	for (auto it : getSectionEntries())
	{
