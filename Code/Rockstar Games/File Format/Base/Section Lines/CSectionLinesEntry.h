...
public:
	...
	void						setEntryType(eSectionLinesEntryType eEntryType) { m_eEntryType = eEntryType; }
	eSectionLinesEntryType		getEntryType(void) { return m_eEntryType; }
...
private:
	...
	eSectionLinesEntryType		m_eEntryType;
