...
class CIPLEntry_CARS : public CIPLEntry_Data
{
public:
	CIPLEntry_CARS(CIPLFormat *pIPLFormat) :
	...
	void						setVehicleColour(CVector2i32& vecVehicleColour) { m_iVehicleColour = vecVehicleColour; }
	CVector2i32&				getVehicleColour(void) { return m_iVehicleColour; }
