...
class CIDEEntry_2DFX_Particle : public CIDEEntry_2DFX
{
public:
	CIDEEntry_2DFX_Particle(CIDEFormat *pIDEFormat) :
	...
	void						setStrength(CVector3D& vecStrength) { m_vecStrength = vecStrength; }
	CVector3D&					getStrength(void) { return m_vecStrength; }
	...
	void						setColour2(CVector3ui32& vecColour2) { m_vecColour2 = vecColour2; }
	CVector3ui32&				getColour2(void) { return m_vecColour2; }
