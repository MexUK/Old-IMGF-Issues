...
class CIDEEntry_CARS : public CIDEEntry_Data
{
public:
	CIDEEntry_CARS(CIDEFormat *pIDEFormat) :
	...
	void						setWheelRadius(CVector2D& vecWheelRadius) { m_vecWheelRadius = vecWheelRadius; }
	CVector2D&					getWheelRadius(void) { return m_vecWheelRadius; }
