...
class CIDEEntry_PEDS : public CIDEEntry_Data
{
public:
	CIDEEntry_PEDS(CIDEFormat *pIDEFormat) :
	...
	void						setPreferredRadioStations(CVector2ui32& vecPreferredRadioStations) { m_vecPreferredRadioStations = vecPreferredRadioStations; }
	CVector2ui32&				getPreferredRadioStations(void) { return m_vecPreferredRadioStations; }
...
private:
	...
	CVector2ui32				m_vecPreferredRadioStations;
