	...
	)
{
	...
	strNewSessionData = getKGM()->getPopupGUIManager()->showTextAreaDialog(CLocalizationManager::getInstance()->getTranslatedText("UpdateSession"), CLocalizationManager::getInstance()->getTranslatedText("Window_TextArea_1_Message"), CStringUtility::join(CStringUtility::split(strSessionData, "; "), "\n"));
	if (CStringUtility::split(strNewSessionData, "\n").size() >= 2)
	{
