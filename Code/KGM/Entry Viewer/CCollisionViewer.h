...
public:
	...
	void						setActiveCOLEntry(CCOLEntry *pCOLEntry) { m_pActiveCOLEntry = pCOLEntry; }
	CCOLEntry*					getActiveCOLEntry(void) { return m_pActiveCOLEntry; }
