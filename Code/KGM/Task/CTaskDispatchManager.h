...
class CTaskDispatchManager : public CManager
{
public:
	void						init(void);
	void						uninit(void);
	...
	void						onRequestConvertIMGVersion(eIMGVersion eIMGVersion);
	...
	void						onRequestConvertDFFToRWVersion(CRWVersion *pRWVersion);
	...
	void						onRequestConvertTXDToGame(ePlatformedGame ePlatformedGame);
	void						onRequestConvertTXDToRWVersion(CRWVersion *pRWVersion);
	...
	void						onRequestConvertTXDToTextureFormat(CRasterDataFormat *pRasterDataFormat);
	...
	void						onRequestConvertCOLtoCOLVersion(CCOLVersion *pCOLVersion);
