...
class CPopupGUIManager : public CManager
{
public:
	void									init(void);
	void									uninit(void);
...
struct CDragDropDialogData
{
	eIMGVersion						m_eDestinationIMGVersion;
	bool							m_bCancel;
	bool							m_bCopy;
	bool							m_bConvert;
	CRWVersion*						m_pDFFConversionRWVersion;
	CCOLVersion*					m_pNewCOLVersion;
	uint32							m_uiTXDConversionOption;
	union
	{
		ePlatformedGame				m_eTXDConversionGame;
		CRWVersion*					m_pTXDConversionRWVersion;
		CRasterDataFormat*			m_pTXDConversionRasterDataFormat;
	};
};
...
struct CTXDOrganizerDialogData
{
	...
	CRasterDataFormat*				m_pRasterDataFormat;
};

struct CDATPathsMoverDialogData
{
	bool							m_bMove;
	CVector2D						m_vecOutputMapRangeMin;
	CVector2D						m_vecOutputMapRangeMax;
	CVector2D						m_vecOutputTileSize;
	CVector3D						m_vecPositionOffset;
...
struct CMapMoverAndIDShifterDialogData
{
	...
	ePlatformedGame					m_eIgnoreDefaultObjectsGame;
